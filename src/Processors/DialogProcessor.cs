...
namespace Draw
{
	...
	public class DialogProcessor : DisplayProcessor
	{
		...
		public void AddRandomIZPITshape()
		{
			...
			IZPITshape izp = new IZPITshape(new Rectangle(x, y, 200, 200));

			izp.FillColor = Color.White;
			izp.BorderColor = Color.Black;
			izp.Opacity = 255;
		...
		public void AddRandomEllipse()
		{
            ...
            EllipseShape elp = new EllipseShape(new Rectangle(x, y, 300, 150));
		...
		public void AddRandomPolygon()
		{
			...
			PolygonShape rect = new PolygonShape(new Rectangle(x, y, 100, 200));
		...
		public void MySerialize(object obj, string filePath = null)
		{
			...
			if (filePath != null)
			{
				stream = new FileStream(filePath + ".jpg",
								  FileMode.Create);
			}
			else
			{
				stream = new FileStream("MyFile.jpg",
										FileMode.Create,
		...
		public void AddRandomLine()
		{
			...
			LineShape line = new LineShape(new Rectangle(x,y,123,12));
